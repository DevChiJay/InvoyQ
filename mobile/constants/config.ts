...
if (!BASE_URL || !validateApiUrl(BASE_URL)) {
  if (!__DEV__) {
    throw new Error(
      "Invalid API URL configuration. HTTPS required in production.",
    );
  }
...
export const STORAGE_KEYS = {
  ...
  BUSINESS_REMINDER_DISMISSED: "invoyq_business_reminder_dismissed",
  FIRST_INVOICE_CREATED: "invoyq_first_invoice_created",
};
