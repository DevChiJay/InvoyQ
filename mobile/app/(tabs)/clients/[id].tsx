          ...
          <Card style={styles.card}>
            ...
            {client.email && (
              <View style={styles.infoRow}>
                ...
                <Text style={[styles.infoText, { color: colors.text }]}>{client.email}</Text>
              </View>
            )}
            ...
            {client.phone && (
              <View style={styles.infoRow}>
                ...
                <Text style={[styles.infoText, { color: colors.text }]}>{client.phone}</Text>
              </View>
            )}
          </Card>
        )}
        ...
        {client.address && (
          <Card style={styles.card}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={[styles.infoText, { color: colors.text }]}>{client.address}</Text>
            </View>
          </Card>
        )}
      </ScrollView>
