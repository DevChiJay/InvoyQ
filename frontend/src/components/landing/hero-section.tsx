        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            ...
            <Button 
              ...
              variant="outline" 
              asChild 
              className="text-lg px-8 py-6 border-2 border-[#6366F1] text-[#6366F1] dark:text-[#E2E8F0] hover:bg-[#6366F1]/10 dark:hover:bg-[#6366F1]/20"
            >
          ...
          <div className="grid grid-cols-3 gap-6 sm:gap-12 max-w-3xl mx-auto">
            <div className="group">
              <div className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-r from-[#6366F1] to-[#14B8A6] bg-clip-text text-transparent mb-2">99%</div>
              <div className="text-sm sm:text-base font-medium text-gray-600 dark:text-[#E2E8F0]/70">Accuracy</div>
            </div>
            <div className="group">
              <div className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-r from-[#14B8A6] to-[#FACC15] bg-clip-text text-transparent mb-2">10x</div>
              <div className="text-sm sm:text-base font-medium text-gray-600 dark:text-[#E2E8F0]/70">Faster</div>
            </div>
            <div className="group">
              <div className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-r from-[#FACC15] to-[#6366F1] bg-clip-text text-transparent mb-2">$0</div>
              <div className="text-sm sm:text-base font-medium text-gray-600 dark:text-[#E2E8F0]/70">To Start</div>
            </div>
          </div>
        </div>
      </div>
